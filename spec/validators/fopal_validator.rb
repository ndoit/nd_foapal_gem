...
module NdFoapalGem
  describe "FopalValidator" do
    ...
    it "validates a valid foapal without an account code" do
    ...
    it "validates a valid foapal with an account code" do
      foapal_entry.fund = '100000'
      foapal_entry.orgn = '34005'
      foapal_entry.acct = '71053'
      foapal_entry.prog = '10000'
      foapal_entry.valid?
      expect(foapal_entry.errors[:base]).to be_empty
    end

    it "indicates the record is invalid if the fund is invalid without an account code" do
    ...
    it "indicates the record is invalid if the orgn is invalid without an account code" do
      foapal_entry.fund = '100000'
    ...
    it "indicates the record is invalid if the acct is populated and is invalid" do
      foapal_entry.fund = '100000'
    ...
    it "indicates the record is invalid if the prog is invalid without an account code" do
      foapal_entry.fund = '100000'
      foapal_entry.orgn = '34000'
    ...
    it "indicates the record is invalid if the actv is invalid without an account code" do
      foapal_entry.fund = '100000'
      foapal_entry.orgn = '34000'
      foapal_entry.prog = '10000'
    ...
    it "indicates the record is invalid if the locn is invalid without an account code" do
      foapal_entry.fund = '100000'
      foapal_entry.orgn = '34000'
      foapal_entry.prog = '10000'
    ...
    it "indicates the record is invalid if the program code is not valid for the fund and orgn without an account code" do
      foapal_entry.fund = '100000'
      foapal_entry.orgn = '34000'
